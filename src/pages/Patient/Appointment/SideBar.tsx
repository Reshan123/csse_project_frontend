...
const SideBar = () => {
  return (
    <div className="w-1/4 h-[610px] p-8 bg-green-200 shadow-md flex flex-col m-4 rounded-2xl justify-center items-center">
      ...
      <button className="flex items-center mb-2 p-4 hover:bg-white rounded-xl transition-colors"
        onClick={() => window.location.href = '/patient/appointment/completed'}
      >
